...
try {
    ...
    // Se eliminó el fallback a INVENTARIO_LEP_SUBSIDIADA: si no hay inventario
    // mensual capturado, la fila se marca como faltante y el JS la pinta en rojo.
    ...
    foreach ($lecherias as &$lech) {
        ...
        $lech['mes_consultado']  = $mes_inv;
        $lech['anio_consultado'] = $anio_inv;
    }
