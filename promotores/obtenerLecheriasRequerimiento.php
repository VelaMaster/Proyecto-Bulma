...
try {
    // Si no se manda almacén → todas las del promotor (multi-almacén).
    ...
    // El requerimiento se calcula con el inventario del MISMO mes base
    // (cierre del 25 del mes en que se captura el requerimiento).
    $mes_inv  = $mes_reporte;
